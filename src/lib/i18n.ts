export const translations = {
  ko: {
    ...
    register: { title: '회원가입', desc: '123MOG와 함께 건강한 식단을 시작하세요', name: '이름', email: '이메일', password: '비밀번호 (6자 이상)', submit: '회원가입', loading: '가입 중...', hasAccount: '이미 계정이 있으신가요?', login: '로그인' },
  ...
  en: {
    ...
    register: { title: 'Sign Up', desc: 'Start your healthy journey with 123MOG', name: 'Name', email: 'Email', password: 'Password (6+ chars)', submit: 'Sign Up', loading: 'Creating...', hasAccount: 'Already have an account?', login: 'Login' },
