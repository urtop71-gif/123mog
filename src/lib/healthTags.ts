...
export function carbsTagFor(carbsPer100g: number | null | undefined): "sugar_good" | "sugar_bad" | "sugar_neutral" | null {
...
export function fatTagFor(fatPer100g: number | null | undefined): "ldl_good" | "ldl_bad" | "ldl_neutral" | null {
...
// healthTags string doesn't already cover, and always adds the computed
// sodium tag (there's no manual equivalent for it yet).
export function augmentHealthTags(healthTags: string | null | undefined, macros: Macros): string | null {
